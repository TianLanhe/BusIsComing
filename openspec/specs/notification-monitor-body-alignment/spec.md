# notification-monitor-body-alignment Specification

## Purpose
TBD - created by archiving change align-monitor-notification-collapsed-body. Update Purpose after archive.
## Requirements
